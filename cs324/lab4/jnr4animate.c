...
{
  glPushMatrix();
  glTranslatef(0.0, 0.0, BAR_LENGTH * 0.5);
  glScalef(BAR_HEIGHT / BAR_LENGTH, BAR_HEIGHT / BAR_LENGTH, 1.0);
  glutWireCube(BAR_LENGTH);
  glPopMatrix();
...
void display()
{
  ...
  glTranslatef(0.0, BAR_HEIGHT * 0.5, 0.0);
...
void main(int argc, char **argv)
{
  ...
  glutCreateWindow("Animated Statue");
  myInit();
